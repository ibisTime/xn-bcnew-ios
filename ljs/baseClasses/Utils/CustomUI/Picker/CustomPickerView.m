...
- (UIPickerView *)selectPicker {
    ...
    if (!_selectPicker) {
        ...
        _selectPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 50, kScreenWidth, 200)];
        ...
        [self.pickerView addSubview:_selectPicker];
    }
...
- (void)setTagNames:(NSArray *)tagNames
{
    ...
    [self.selectPicker selectedRowInComponent:0];
